<template>
  <div class="shopping-cart__item">
    ...
    <div class="shopping-cart__details">
      <div class="shopping-cart__details-title">{{ cartItem.title }}</div>
      <div class="shopping-cart__details-category">{{ cartItem.category }}</div>
      <div class="shopping-cart__details-rating">
        <rating :rating="cartItem.rating.rate" />
      </div>
      <div class="shopping-cart__details-price">{{ currency }}</div>
      <div class="shopping-cart__details-link" @click="goToDetails">
        Show details
      </div>
    </div>
    <div class="shopping-cart__item-remove">
      <icon-close @click="onCloseClick" />
    </div>
  </div>
</template>
